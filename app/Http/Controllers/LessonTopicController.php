...
class LessonTopicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $classSubject = $this->class_subjects->builder()->with('subject')->where('subject_id', $request->subject_id)->first();

            $title = 'Topic Alert !!!';
            $body = 'A new topic has been added to the lesson "' . $request->name .
                '" under the subject "' . $classSubject->subject_with_name . '".';
            $type = 'lesson';

            $baseCustomData = [
                'lesson_id' => $request->lesson_id,
                'class_subject_id' => $request->subject_id, // KEEP AS-IS
            ...
            /**
             * Get students exactly as your existing logic expects
             */
    ...
    public function show()
    {
        ...
        $sql = $this->topic->builder()
            ...
            ->when(request('class_id') != null, function ($query) {
                ...
                $query->whereHas('lesson.lesson_commons.class_section', function ($q) use ($class_id) {
        ...
        foreach ($res as $row) {
            ...
            $lessonTopicCommons = $row->lesson->lesson_commons->map(function ($common) {
    ...
    public function update($id, Request $request)
    {
        ...
        try {
            ...
            $subjectName = $this->class_subjects->builder()
                ->with('subject')
            ...
            /**
             * KEEP EXISTING STUDENT QUERY — DO NOT TOUCH
             */
            $students = $this->student->builder()
                ->with('user')
