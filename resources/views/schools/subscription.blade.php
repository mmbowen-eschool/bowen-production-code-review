                ...
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['registration'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['active'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['deactivate'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['over_due'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['unpaid'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 grid-margin stretch-card">
                <div class="card aligner-wrapper">
                    <div class="custom-card-body">
                        ...
                        <div class="d-flex align-items-center">
                            <h3 class="font-weight-medium mb-2">{{ $data['paid'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
