                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <div class="col-12 d-flex row">
                                        ...
                                        {{-- <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="type" value="4" required="required">
                                                {{ __('student_web') }}
                                            </label>
                                        </div> --}}
                                    </div>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-12 d-flex row">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input edit_type" name="type" value="4" required="required">
                                                {{ __('student_web') }}
                                            </label>
                                        </div>
                                    </div>
