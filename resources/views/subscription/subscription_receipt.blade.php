        ...
        <div class="main-body mt-3">
            <table class="full-width-table bill-info">
                ...
                <tr>
                    ...
                    <td>Students</td>
                    <td class="text-right">{{ format_money($student_charges) }}</td>
                    <td class="text-right">{{ $subscriptionBill->total_student }}</td>
                    <td class="text-right">
                        {{ format_money($student_charges * $subscriptionBill->total_student) }}
                    </td>
                </tr>

                <tr>
                    <td>Staffs</td>
                    <td class="text-right">{{ format_money($staff_charges) }}</td>
                    <td class="text-right">{{ $subscriptionBill->total_staff }}</td>
                    <td class="text-right">
                        {{ format_money($staff_charges * $subscriptionBill->total_staff) }}
                    </td>
                ...
                <tr>
                    ...
                    <th class="text-right">
                        {{ format_money($total_user_charges) }}</th>
                </tr>
                @else
                <tr>
                    <th colspan="4" class="text-left"> Package Amount : </th>
                    <th class="text-right">
                        {{ format_money($subscriptionBill->subscription->charges) }}</th>
                </tr>
                @endif
                ...
                @if ($subscriptionBill->subscription->package_type == 1)
                    ...
                    <tr>
                        ...
                        <th class="text-right">
                            {{ format_money($addons_charges) }}</th>
                    </tr>
                    <tr>
                        <th colspan="4" class="text-left">Total User Charges : </th>
                        <th class="text-right">
                    ...
                    @if ($deafult_amount > number_format($total_amount, 2))
                        <tr>
                            ...
                            <th class="text-right">
                                {{ format_money($deafult_amount) }}</th>
                        </tr>
                    @endif
                    {{-- End Postpaid --}}
                @else
                    ...
                    <tr>
                        <th colspan="4" class="text-left">Total Bill Amount : </th>
                        <th class="text-right">
                            {{ format_money($total_amount + $addons_charges) }}</th>
                    </tr>
