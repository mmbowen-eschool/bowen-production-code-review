                                        ...
                                        <div class="text-center pricing-card-head mb-2">
                                            ...
                                            <div class="row">
                                                ...
                                                @elseif($package->type == 0)
                                                    ...
                                                    <div class="col-sm-12 col-md-12">
                                                        <h3> {{ format_money($package->charges) }}
                                                        </h3>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 mt-3 text-small">
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-sm-12 col-md-12 mt-3 text-small">
                                                        <h5>
                                                            ...
                                                            {{ format_money($package->student_charge) }} / {{ __('per_staff_charges') }}
                                                            : {{ format_money($package->staff_charge) }}
                                                        </h5>
                                                    </div>
                            ...
                            success: function(response) {
                                if (response.data) {
                                    ...
                                    var options = {
                                        ...
                                        100, // Amount is in currency subunits. Default currency is MMK. Hence, 100 refers to 100 MMK
                                        "currency": "{{ $system_settings['currency_code'] ?? 'MMK' }}",
