                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @if ($package_type == 1)
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right">
                                                    {{ format_money($total_user_charge) }}
                                                </th>
                                            </tr>
                                        ...
                                        @if ($subscriptionBill->subscription->package_type == 0)
                                            <tr>
                                                ...
                                                <th class="text-right">
                                                    {{ format_money($subscriptionBill->amount) }}
                                                </th>
                                            </tr>
                                        @endif
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">
                                                @if ($subscriptionBill->subscription->package_type == 1)
                                                    {{ format_money($total_user_charge + $addon_charges) }}
                                                @else
                                                    {{ format_money($subscriptionBill->amount + $addon_charges) }}
                                                @endif
                                            </th>
                                        </tr>
                                    </table>
