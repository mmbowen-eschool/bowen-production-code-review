                        ...
                        <div class="row">
                            ...
                            @if ($active_package && $active_package->package_type == 1)
                                <div class="form-group col-sm-12 col-md-3">
                                    <label for="">{{ __('per_active_student_charges') }}</label>
                                ...
                                <div class="form-group col-sm-12 col-md-3">
                                    <label for="">{{ __('per_active_staff_charges') }}</label>
                                ...
                                <div class="form-group col-sm-12 col-md-12 table-responsive">
                                    <table class="table table-bordered" data-mobile-responsive="true">
                                        ...
                                        <tr>
                                            ...
                                            @if ($active_package->package_type == 1)
                                                <td class="text-right">{{ $data['students'] ?? 0 }}</td>    
                                            @else
                                                <td class="text-right">{{ $data['students'] ?? 0 }} / {{ $active_package->no_of_students }}</td>
                                            @endif
                                            
                                            <td class="text-right">
                                                {{ format_money(($data['students'] ?? 0) * $active_package->student_charge) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            @if ($active_package->package_type == 1)
                                                <td class="text-right">{{ $data['staffs'] ?? 0 }}</td>    
                                            @else
                                                <td class="text-right">{{ $data['staffs'] ?? 0 }} / {{ $active_package->no_of_staffs }}</td>
                                            @endif
                                            
                                            <td class="text-right">
                                                {{ format_money(($data['staffs'] ?? 0) * $active_package->staff_charge) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th colspan="4">{{ __('Total User Charges') }} :</th>
                                            <th class="text-right">
                                                {{ format_money(($data['students'] ?? 0) * $active_package->student_charge + ($data['staffs'] ?? 0) * $active_package->staff_charge) }}
                                                @php
                                                    $total_user_charges = ($data['students'] ?? 0) * $active_package->student_charge + ($data['staffs'] ?? 0) * $active_package->staff_charge;
                                                @endphp
                                            </th>
                                        </tr>
                                        {{-- Prepaid --}}
                                        @else
                                            <tr>
                                                ...
                                                <th class="text-right">
                                                    {{ format_money($active_package->charges) }}
                                        ...
                                        @if ($active_package)
                                            @foreach ($active_package->addons as $addon)
                                                <tr>
                                                    ...
                                                    <td class="text-right">{{ format_money($addon->price) }} </td>
                                                    @php
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right">
                                                {{ format_money($total_addon_charges) }}
                                            </th>
                                        </tr>
                                        <tr>
                                            ...
                                            @if ($active_package->package_type == 1)
                                                <th class="text-right">
                                                    {{ format_money($total_addon_charges + $total_user_charges) }}
                                                </th>
                                            @else
                                                <th class="text-right">
                                                    {{ format_money($total_addon_charges + $active_package->charges) }}
                                                </th>
                                            @endif
