                            ...
                            <div class="border border-secondary rounded-lg my-4 mx-1">
                                <div class="row my-4 mx-1">
                                    ...
                                    <div class="form-group col-md-2">
                                        ...
                                        <span style="color: rgb(0, 55, 107);font-size: 0.8rem" class="ml-2">eg :- mmk</span>
                                    </div>
                                    <div class="form-group col-md-2">
                                        ...
                                        <span style="color: rgb(0, 55, 107);font-size: 0.8rem" class="ml-2">eg :- {{ $settings['currency_symbol'] ?? 'K' }}</span>
                                    </div>
